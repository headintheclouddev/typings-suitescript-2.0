...
export interface NS2_Client_FieldChangedContext {
...
export interface NS2_Client_FieldChanged {
    (scriptContext?: NS2_Client_FieldChangedContext): void;
}

export interface NS2_Client_LineInitContext {
    currentRecord: ClientCurrentRecord;
    sublistId: string;
}

export interface NS2_Client_LineInit {
    (scriptContext?: NS2_Client_LineInitContext): void;
}

export interface NS2_Client_PageInitContext {
    currentRecord: ClientCurrentRecord;
    mode: string;
}

export interface NS2_Client_PageInit {
    (scriptContext?: NS2_Client_PageInitContext): void;
}

export interface NS2_Client_PostSourcingContext {
    currentRecord: ClientCurrentRecord;
    sublistId: string;
    fieldId: string;
}

export interface NS2_Client_PostSourcing {
    (scriptContext?: NS2_Client_PostSourcingContext): void;
}

export interface NS2_Client_SaveRecord {
    (scriptContext?: NS2_Client_SaveRecordContext): boolean;
}

export interface NS2_Client_SaveRecordContext {
    currentRecord: ClientCurrentRecord;
}

export interface NS2_Client_SublistChangedContext {
    currentRecord: ClientCurrentRecord;
    sublistId: string;
    /**
     * Commit, etc.
...
export interface NS2_Client_SublistChanged {
    (scriptContext?: NS2_Client_SublistChangedContext): void;
}

export interface NS2_Client_ValidateDeleteContext {
    currentRecord: ClientCurrentRecord;
    sublistId: string;
}

export interface NS2_Client_ValidateDelete {
    (scriptContext?: NS2_Client_ValidateDeleteContext): boolean;
}

export interface NS2_Client_ValidateFieldContext {
    currentRecord: ClientCurrentRecord;
    sublistId: string;
    fieldId: string;
    lineNum?: string;
...
export interface NS2_Client_ValidateField {
    (scriptContext?: NS2_Client_ValidateFieldContext): boolean;
}

export interface NS2_Client_ValidateInsertContext {
    currentRecord: ClientCurrentRecord;
    sublistId: string;
}

export interface NS2_Client_ValidateInsert {
    (scriptContext?: NS2_Client_ValidateInsertContext): boolean;
}

export interface NS2_Client_ValidateLineContext {
    currentRecord: ClientCurrentRecord;
    sublistId: string;
}

export interface NS2_Client_ValidateLine {
    (scriptContext?: NS2_Client_ValidateLineContext): boolean;
}

export interface NS2_UE_BeforeLoadContext {
    newRecord: Record;
    type: string;
    form: UIForm;
...
export interface NS2_UE_BeforeSubmitContext {
    newRecord: Record;
    oldRecord: Record;
    type: string;
    UserEventType: NS2_UserEventTypes;
...
export interface NS2_UE_AfterSubmitContext {
    newRecord: Record;
    oldRecord: Record;
    type: string;
    UserEventType: NS2_UserEventTypes;
...
export interface NS2_UserEventTypes {
    APPROVE: string;
    CANCEL: string;
...
export interface NS2_ScheduledScriptContext {
    type: NS2_ScheduledInvocationTypes;
}

export interface NS2_ScheduledInvocationTypes {
    SCHEDULED: string;
    ON_DEMAND: string;
    USER_export interface: string;
    ABORTED: string;
    SKIPPED: string;
}

export interface NS2_MapReduce_MapContext {
    key: string;
    value: string;
    write: (key: string, value: string) => void;
}

export interface NS2_MapReduce_ReduceContext {
    key: string;
    values: string[];
    write: (key: string, value: string[]) => void;
}

export interface NS2_MapReduce_Iterator {
    each(callback: (key: string, value: string) => void): void;
}

export interface NS2_MapReduce_IteratorContainer {
    iterator(): NS2_MapReduce_Iterator;
}

export interface NS2_MapReduce_SummaryContext {
    dateCreated: Date;
    seconds: number;
    usage: number;
    concurrency: number;
...
export interface NS2_MapReduce_InputSummary {
    dateCreated: Date;
    seconds: number;
    usage: number;
    error: string;
...
export interface NS2_MapReduce_MapSummary {
    dateCreated: Date;
    seconds: number;
    usage: number;
    concurrency: number;
...
export interface NS2_MapReduce_ReduceSummary {
    dateCreated: Date;
    seconds: number;
    usage: number;
    concurrency: number;
...
export interface NS2_MapReduce_SummaryFunction {
    (summary: NS2_MapReduce_SummaryContext): void;
}

export interface NS2_MassUpdate_Context {
    id: string;
    type: string;
}

export interface NS2_Portlet_Form_Context {
    portlet: PortletForm;
}

export interface NS2_Portlet_HTML_Context {
    portlet: PortletHTML;
}

export interface NS2_Suitelet_Context {
...
export interface PortletForm { // Haven't validated that all these methods actually exist yet 
