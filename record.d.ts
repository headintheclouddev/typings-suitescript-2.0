import {GetSelectOptionsOpts} from './ui/serverWidget';

export interface RecordSaveFunction {
...
export interface AttachRecordOptions {
    type: string;
    id: number | string;
}

export interface CancelCommitLineOptions {
    sublistId: string;
}
...
export interface RecordGetLineCountOptions {
    sublistId: string;
}
...
export interface SetCurrentSublistTextOptions {
    sublistId: string;
    fieldId: string;
...
export interface RecordDetachFunction {
