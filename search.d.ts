...
export interface SearchColumnSetWhenOrderedByOptions {
    name: string;
    join: string;
}
...
export interface SearchResultGetValueTextOptions {
    name: string;
    join: string;
    summary?: string;
}
...
export interface SearchResultSetGetRangeOptions {
    start: number;
    end: number;
}

export interface SearchResultSetGetRangeFunction {
    promise(options: SearchResultSetGetRangeOptions): Promise<SearchResult[]>;
    (options: SearchResultSetGetRangeOptions): SearchResult[];
}

export interface SearchResultSetEachFunction {
...
export interface PageNextFunction {
    promise(): Promise<Page>;
    (): Page;
}

export interface PagePrevFunction {
    promise(): Promise<Page>;
    (): Page;
}

export interface PagedDataFetchFunction {
...
export interface RunPagedOptions {
    /**
...
export interface SearchRunPagedFunction {
...
export interface SearchLookupFieldsOptions {
    type: string;
    id: string;
    columns: (string | string[]);
}

export interface SearchLookupFieldsFunction {
...
export interface SearchCreateFunction {
...
export interface SearchTypes { // as of 3/23/2016
    ACCOUNT: string;
