...
interface pluginConfiguration {
  ...
  getConfigurationFieldValue: (
    options: getConfigurationFieldValueOptions,
  ) => string;
}
...
export interface getStandardTransactionCodesContext {
  ...
  createNewStandardTransactionCode: (
    options: createNewStandardTransactionCodeOptions,
  ) => void;
}
 ...
 */
export type getStandardTransactionCodes = (
  options: getStandardTransactionCodesContext,
) => void;
 ...
 */
export type getConfigurationPageUrl = (
  options: getConfigurationPageUrlContext,
) => void;
