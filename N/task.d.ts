...
interface SuiteQLTask {
   ...
   */
  readonly inboundDependencies: Record<
    string,
    {
      id: string;
      type: TaskType.SCHEDULED_SCRIPT | TaskType.MAP_REDUCE;
      scriptId: string;
      deploymentId: string;
      params?: {};
    }
...
export function create(
  options: EntityDeduplicationTaskCreateOptions,
): EntityDeduplicationTask;
export function create(
  options: MapReduceScriptTaskCreateOptions,
): MapReduceScriptTask;
export function create(
  options: ScheduledScriptTaskCreateOptions,
): ScheduledScriptTask;
export function create(
  options: WorkflowTriggerTaskCreateOptions,
): WorkflowTriggerTask;
...
export function create(
  options: RecordActionTaskCreateOptions,
): RecordActionTask;
export function create(options: SuiteQLTaskCreateOptions): SuiteQLTask;
export function create(
  options: DocumentCaptureTaskCreateOptions,
): DocumentCaptureTask;
