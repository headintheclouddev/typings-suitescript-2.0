...
export namespace EntryPoints {
  namespace Client {
    ...
    type localizationContextEnter = (
      scriptContext: localizationContext,
    ) => void;
  ...
  namespace RESTlet {
    type get<T = unknown, Y = string> = (
      requestParams?: Partial<T>,
    ) => Promise<Y> | Y;
    type delete_<T = unknown, Y = string> = (
      requestParams?: Partial<T>,
    ) => Promise<Y> | Y;
    type post<T = unknown, Y = string> = (
      requestBody?: Partial<T> | string,
    ) => Promise<Y> | Y;
    type put<T = unknown, Y = string> = (
      requestBody?: Partial<T> | string,
    ) => Promise<Y> | Y;
  }
  ...
  namespace Plugins {
    namespace FiParser {
      ...
      interface getExpenseCodesContext
        extends N_FiParser.getExpenseCodesContext {}
    ...
    namespace FiConnectivity {
      ...
      interface getAccountsContext
        extends N_FiConnectivity.getAccountsContext {}
      ...
      type getConfigurationIFrameUrl =
        N_FiConnectivity.getConfigurationIFrameUrl;
    }
