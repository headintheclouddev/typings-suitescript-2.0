...
import {ClientResponse, ServerRequest, ServerResponse, HttpGetFunction, HttpDeleteFunction, HttpPostFunction, HttpPutFunction, HttpRequestFunction, HttpMethod, CacheDuration} from './http';

export interface CreateSecureKeyOptions {
    /**
...
export interface CreateSecureStringOptions {
    /**
...
export interface AppendStringOptions {
    /**
...
export interface AppendSecureStringOptions {
    /**
...
export interface ConvertEncodingOptions {
    /**
